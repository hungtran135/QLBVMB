...
namespace QLBVMB
{
    ...
    public partial class Quan_ly_nhan_vien : Form
    {
        ...
        internal bool CheckDataNV(DTO.Nhanvien nv)
        {
            if (nv.manv == null || nv.tennv == null || nv.diachi == null || nv.sdt == null || nv.email == null || nv.cmnd == null || nv.username == null || nv.password == null || nv.loai == null || nv.passwordlv2 == null)
                return false;
            else
                return true;
        }
